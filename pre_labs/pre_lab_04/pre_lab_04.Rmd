...
**Some variables in the 'recipient_name' field are the same, but have either different punctuation or case types.**
...
**It changed the case type of some variables and removed the punctuation from others.**
...
**Refinr condensed several variables into the a single variable by removing the punctuation and changing their case. For example, 'W. MILLAR & CO', 'W. MILLAR & CO.' and 'W. Millar & Co.' was condensed into a single variable. It also condensed variables that shared the same info but had different names, such as 'W. MILLAR & CO. CATERING' and 'W.Millar & Company Catering'.**
...
**I don't think the end result is visually different from the previous result of key_collision_merge.**
