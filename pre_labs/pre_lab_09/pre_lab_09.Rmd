...
**Answer** The original map showed the entirety of the United States, including data we don't have regions for. The new map only shows Maryland, albeit tilted to the side.
...
**Answer** The new map showcases the percentage of votes that went to Moore per county.
...
**Answer** https://datawrapper.dwcdn.net/9xtv8/1/
