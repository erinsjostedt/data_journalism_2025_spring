...
In the space below, write the data type for the "last_name" column and the "amount" columns (it's in light gray, offset by \< \>). Also offer your best guess as to what the "last_name" column and the "amount" column represent. **<chr>**
...
**the code is sorting each obs. by date**
...
**the order is now from most recent to least recent by date**
...
**the objects are now sorted by amount and memo text column**
...
**objects are now sorted by total amount donated per memo text block**
...
**this one factors in mean and median to see if any large donations are skewing the total**
...
Compared to the previous codeblock, what has changed and how did that affect the result? How is the data sorted? **this codeblock shows cities in MD as a factor as well as amount and count_contribs**
