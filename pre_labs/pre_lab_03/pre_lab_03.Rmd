...
**"Warning: One or more parsing issues, call `problems()` on your data frame for details, e.g.:
  dat <- vroom(...)
  problems(dat)Rows: 476915 Columns: 13── Column specification "**
...
**The "precinct" field is character data, and the "mail" column is dbl type.**
...
**There are 402,345 results where the mail is NA. I think this might imply that 402,345 of the total votes were not mailed in?**:
...
**There were 12 registrants in January 1900. I think the first 20 results suggest that there are usually very few voter registrations, with registrations picking up in 1966.**
...
**I think it could be interesting to explore how this data is obtained, specifically in the cases of deceased voters and people who have moved.**
...
**The "amount" field is currently characters, not dbl.**
...
**The "amount" field is the character data type and can't be read numerically, the values in the "city" field are in a variety of formats, and there are several rows that have the same tran_id but share the same first name, last name and address, so they might be duplicates.**
...
**The code changed the colum "1_linenumber" to "x1_linenumber.**
...
**The error says it was "Caused by error in `sum()`." I think the issue here is that the data type for "amount" is set to <chr>, not <dbl>.**
...
**There are two duplicates names Derrick Hamilton.**
...
**The new data frame has 13 rows.**
...
**All rows now have the same zipcode, which also match with the city and state.**
...
**There are still two misspellings of Conowingo.**
...
**There is still one misspelling of Conowingo.**
...
**There are no more mispellings of Conowingo.**
