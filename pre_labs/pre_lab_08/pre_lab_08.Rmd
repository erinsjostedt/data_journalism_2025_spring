...
```{r}
md_voters <- read_csv("maryland_voters_2024_2022.csv")
```
...
**This code is figuring out which counties had the biggest jump in unaffiliated voters between 2022 and 2024. First, it creates a new column called UNAF_DIFF by subtracting the 2022 numbers from the 2024 ones. Then it sorts the data so the counties with the biggest increases show up first. After that, it keeps only the county names and the differences, and shows the top 10 counties with the biggest changes.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **I see a blank white box.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **I see a bar chart, well executed.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **the county names arent in alphabetical order, but the bars are sorted by smallest to largest**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Now the names are on the left and the bars are horizontal not vertical. This reads easier**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **the background is all one color**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **It is more aesthetic now and there is a theme of colors nad fonts.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **The chart has a title and the axis names are cleaner.**
...
```{r}
md_winred <- read_rds("maryland_winred.rds")
```

**Task** Run the following code. Explain what you see after running the code in the space below. **I see date and total contribution arranged descending.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **I see a line graph representing the data we just pulled before**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **There are specific dates on the bottom, and this gives more clarity for the x axis**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **The names are not so jumbled anymore, theyre slanted.**
