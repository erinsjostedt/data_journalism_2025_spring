...
**Answer** It has 24 rows and 18 columns.
...
**Answer**The first part of the code block is creating a new column for the difference in unaffiliated voters per county between 2024 and 2022. The second part of the code block is creating a new dataset called `maryland_top_counties` that contains the ten counties with the highest difference in unaffiliated voters.
...
**Answer** The code created a blank canvas.
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** The code created a bar chart by using County as the x-axis and UNAF_DIFF as the y-axis.
...
**Answer** The counties are now ordered from lowest to highest based on the variable used for the y-axis.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The new chart is horizontal instead of vertical, which improved its overall readability.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The colors and layout of the chart changed; the background is lighter and the text is spaced differently.
...
**Answer** The new chart lacks the grid background seen in the last chart, and the background is now a light grey-blue.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The chart now has an identifying title, names for each axis and a caption that identifies the source of the data.
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** The code displays the number of individual contributions made on each date.
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** The results of the code is a basic line craft that measures the number of contributions made per day on the y-axis and the date on the x-axis.
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** The new chart shows specific dates one week apart instead of just showing them month-by-month.
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** The new chart rotated the dates along the x-axis, making them easier to read.
