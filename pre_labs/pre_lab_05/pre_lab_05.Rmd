...
**They do have the same column structure.**
...
**The output says the datasets were joined by county (`by = join+by(COUNTY)`)**
...
**The results vary in that the percentage of the 18+ Asian democrats in each county is remarkably higher than the actual 18+ Asian population percentage.**
...
**ZCTA5N has a <dbl> datatype, so the computer will read it as a number.**
...
**The ZCTA5N column now has the <chr> datatype.**
