...
```{r}
voters_by_county <- read_csv("data/tabula_eligible_active_voters_by_county.csv")
...
```{r}
benzie_2024 <- read_csv("data/tabula_Benzie_Aug2024_Precinct_Results.csv")
...
**Task** Get rid of rows we don't need by running the codeblock below. What problems remain? **There is no party column, and X2/X3/etc is an ineffective title for our variables.**

```{r}
benzie_2024 <- read_csv("data/tabula_Benzie_Aug2024_Precinct_Results.csv", col_names = FALSE)
