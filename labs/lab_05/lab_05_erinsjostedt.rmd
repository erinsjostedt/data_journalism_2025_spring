...
july_harris <- read_csv("july_harris.csv")
august_harris <- read_csv("august_harris.csv")
...
new_voters <- read_csv("new_voters.csv")
```
...
combined_combined <- harris_combined |>
...
A1. We chose these columns before we did it together as a class, and we did this by going through both datasets and seeing which columns they both contain.
...
A2. 326 donations have come from people who registered this year, 77 donations since July 20. Brandyn Best gave the most amount of donations since July 20 at 4 donations.
...
A3. Harris got 32 donations from non-democrats. The gender breakdown is below. 
...
A4: How many of the voters that registered this year live in Baltimore? ANSWER: 53
