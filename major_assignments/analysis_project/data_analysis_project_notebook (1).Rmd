...
clean_mail_in_ballots <- read_csv("clean_mail_in_ballots.csv")
clean_early_voting_turnout <- read_csv("clean_early_voting.csv")
...
**Answer: For Prince George's county, day 8 (the last day of early voting) had the highest number of early votes with a total of 6,338. Day 3 had the lowest number of early votes with a total of 1,154. The difference between the highest and lowest days was 5184 votes, with day 8 receiving around 138% more votes than day 3.** **
```{r}
...
**Answer:The counties with the largest gaps between eligible voters and early votes cast in the 2024 Maryland primary were Montgomery County (660,471), Prince George’s County (521,643), and Baltimore County (419,729). These gaps seem to appear where early voting engagement lacked the most in numbers due to the counties’ high population sizes and differences.**
```{r}
