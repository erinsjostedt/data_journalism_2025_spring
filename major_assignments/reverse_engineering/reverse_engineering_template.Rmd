...
For the second part of the sentence, we simply filtered for donations made by Mark R Craig during the dates the session took place during. We then used summarize to get the total sum of his donations. We found that he donated a total of $33,200 during the session, which matched what the article said.
